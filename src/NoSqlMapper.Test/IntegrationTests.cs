...
namespace NoSqlMapper.Test
{
    public static class IntegrationTests
    {
        ...
        [TestMethod]
        public static async Task DatabaseTest_InsertWithId(NsConnection nsClient)
        {
        ...
        [TestMethod]
        public static async Task DatabaseTest_FindAll_ContainsArray(NsConnection nsClient)
        {
        ...
        [TestMethod]
        public static async Task DatabaseTest_FindAll_Collection1(NsConnection nsClient)
        {
